...
I've noticed that I'm chatting with devs about agents but we're meaning two different things. Claude Code in a sandbox vs. the agentic endpoint in my web app. It's a spectrum but I think we can distinguish two types of agents by now and they're running on different infrastructure and abstraction levels.
