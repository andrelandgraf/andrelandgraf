...
{% statement %}
Remix embraces the web platform and provides thoughtfully designed conventions, levers, and primitives for existing web APIs and standards.
{% /statement %}
...
{% statement %}
Remix is a healthy combination of what works (the web platform) and new ideas, trends, and technologies.
{% /statement %}
...
{% statement %}
Remix addresses the pain points of SPAs and still lets me build modern web apps.
{% /statement %}
...
{% statement %}
Remix is the perfect replacement for an SPA and works well in microservice architectures as it can aggregate data on the server and avoid overfetching.
{% /statement %}
...
{% statement %}
Coming from MERN, Remix provides insane quality-of-life improvements and a better user experience out of the box.
{% /statement %}
...
{% statement %}
Remix is about providing levers to optimize for what's most important to you.
{% /statement %}
...
{% statement %}
Remix's ability to run anywhere adds to its flexibility. Remix's adapters let you choose a platform and environment based on your own requirements.
{% /statement %}
